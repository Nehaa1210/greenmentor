...
const Tasks = () => {
  ...
  const fetchTasks = useCallback(() => {
    const config = { url: "https://greenbackend-1.onrender.com/api/tasks", method: "get", headers: { Authorization: authState.token } };
  ...
  const handleDelete = (id) => {
    const config = { url: `https://greenbackend-1.onrender.com/api/tasks/${id}`, method: "delete", headers: { Authorization: authState.token } };
